...
export default function KShopPage() {
  ...
  const p = t("projectPages.kShop", { returnObjects: true }) as {
    back: string;
    badge: string;
    title: string;
    tagline: string;
  ...
  return (
    <div className="font-body bg-[color:var(--bg)] min-h-screen overflow-x-hidden">
      ...
      >
        <img
          src="/assets/images/projects/k-shop/k-shop-hero.png"
          alt="K-Shop"
      ...
      >
        ...
        <div className="reveal-item">
          <a
            href="https://k-shop.konlakarn.space/"
            target="_blank"
